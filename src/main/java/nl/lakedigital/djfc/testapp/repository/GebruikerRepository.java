package nl.lakedigital.djfc.testapp.repository;

import nl.lakedigital.djfc.testapp.domein.Gebruiker;
import nl.lakedigital.djfc.testapp.domein.Relatie;
...
public class GebruikerRepository {//extends AbstractRepository<Gebruiker> {
    ...
    @Autowired
    private SessionFactory sessionFactoryDJFC;

    public void setSessionFactoryDJFC(SessionFactory sessionFactory) {
